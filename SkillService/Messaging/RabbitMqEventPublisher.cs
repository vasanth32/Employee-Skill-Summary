...
public class RabbitMqEventPublisher : IEventPublisher, IDisposable
{
    ...
    public RabbitMqEventPublisher(IConfiguration configuration)
    {
        ...
        _exchange = rabbitSection["SkillExchange"] ?? rabbitSection["Exchange"] ?? "skill.events";
    ...
    public Task PublishSkillRatedAsync(SkillRatedEvent message, CancellationToken cancellationToken)
    {
